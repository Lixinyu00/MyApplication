...
import com.hiveview.cloudscreen.search.common.AppConstants;
import com.hiveview.cloudscreen.search.common.CloudScreenApplication;
...
public class DisplayImageUtil extends HashMap<String, DisplayImageOptions> {
    ...
    private int overseasLoadingImage;
    private int errorImage;
    private int overseasErrorImage;
    private int emptyUriImage;
    private int overseasEmptyUriImage;
    private Drawable loadingDrawable;
    private Drawable overseasLoadingDrawable;
    private Drawable errorDrawable;
    private Drawable overseasErrorDrawable;
    private Drawable emptyUriDrawable;
    private Drawable overseasEmptyUriDrawable;
    ...
    private void reset() {
        round = 0;
        loadingImage = 0;
        overseasLoadingImage = 0;
        errorImage = 0;
        overseasErrorImage = 0;
        emptyUriImage = 0;
        overseasEmptyUriImage = 0;
        loadingDrawable = null;
        overseasLoadingDrawable = null;
        errorDrawable = null;
        overseasErrorDrawable = null;
        emptyUriDrawable = null;
        overseasEmptyUriDrawable = null;
        duration = DURATION;
        roundLeftTop = 0;
    }
    ...
    public DisplayImageUtil setOverseasLoadingImage(int loadingImage) {
        this.overseasLoadingImage = loadingImage;
        return this;
    }
    ...
    public DisplayImageUtil setOverseasLoadingDrawable(Drawable loadingDrawable) {
        this.overseasLoadingDrawable = loadingDrawable;
        return this;
    }
    ...
    public DisplayImageUtil setOverseasErrorImage(int errorImage) {
        this.overseasErrorImage = errorImage;
        return this;
    }
    ...
    public DisplayImageUtil setOverseasErrorDrawable(Drawable errorDrawable) {
        this.overseasErrorDrawable = errorDrawable;
        return this;
    }
    ...
    public DisplayImageUtil setOverseasEmptyUriImage(int emptyUriImage) {
        this.overseasEmptyUriImage = emptyUriImage;
        return this;
    }
    ...
    public DisplayImageUtil setOverseasEmptyUriDrawable(
            Drawable emptyUriDrawable) {
        this.overseasEmptyUriDrawable = emptyUriDrawable;
        return this;
    }
    ...
    public void cancelDisplayTask(ImageView imageView) {
        CloudScreenApplication.getInstance().imageLoader
    ...
    public static class Builder {
        ...
        public Builder setOverseasLoadingImage(int loadingImage) {
            container.overseasLoadingImage = loadingImage;
            return this;
        }
        ...
        public Builder setOverseasErrorImage(int errorImage) {
            container.overseasErrorImage = errorImage;
            return this;
        }
        ...
        public Builder setOverseasEmptyUriImage(int emptyUriImage) {
            container.overseasEmptyUriImage = emptyUriImage;
            return this;
        }
    ...
    private DisplayImageOptions obtain() {
        ...
        String key = generateKey(roundLeftTop, round, loadingImage,
                loadingDrawable == null ? 0 : loadingDrawable.hashCode(),
                errorImage,
                errorDrawable == null ? 0 : errorDrawable.hashCode(),
                emptyUriImage,
                emptyUriDrawable == null ? 0 : emptyUriDrawable.hashCode(),
                duration, cacheInMemoryFlag);
        if (containsKey(key)) {
            return get(key);
        } else {
            DisplayImageOptions.Builder builder = new DisplayImageOptions.Builder();
            if (round != 0) {
                builder.displayer(new RoundedFadeInBitmapDisplayer(duration,
                        round));
            ...
            if (false) {
                if (loadingImage != 0) {
                    builder.showImageOnLoading(overseasLoadingImage);
                }
                if (null != loadingDrawable) {
                    builder.showImageOnLoading(overseasLoadingDrawable);
                }
                if (emptyUriImage != 0) {
                    builder.showImageForEmptyUri(overseasEmptyUriImage);
                }
                if (null != emptyUriDrawable) {
                    builder.showImageForEmptyUri(overseasEmptyUriDrawable);
                }
                if (errorImage != 0) {
                    builder.showImageOnFail(overseasErrorImage);
                }
                if (null != errorDrawable) {
                    builder.showImageOnFail(overseasErrorDrawable);
                }
            } else {
                if (loadingImage != 0) {
            ...
            DisplayImageOptions options = builder.cacheOnDisk(true)
    ...
    public static String createImgUrl(String url, boolean isPortrait) {
        ...
        if (isPortrait) {
            newUrl = new StringBuilder(subString).append("_260_360").append(
                    subString1);
        } else {
            newUrl = new StringBuilder(subString).append("_320_180").append(
                    subString1);
        }
